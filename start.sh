...
PROJECT_NAME="bradesco-pre-cadastro"  # Nome do projeto (usado para a pasta do site)
DOMAIN="bradesco-pre-cadastro.picbrand.dev.br"  # Domínio configurado no Nginx
PROJECT_PATH="/home/ec2-user/Pre-cadastro-Bradesco-lollapalooza-2025"  # Caminho do projeto no servidor
...
# 🔹 Criando diretório exclusivo para o projeto
